...
<head>
  ...
  <link rel="stylesheet" href="../panel_gerencia/styles/styles5.css">
...
<body>
  ...
  <div>
    <ul class="navbar" id="myNavbar">
      <nav class="barra">
        <div class="logo">
          <img src="../panel_gerencia/logo/jard.png" alt="logo de pagina">
        </div>
        <!-- Opciones de navegación -->
        <li><a href="../panel_gerencia/gerencia_panel.php">Inicio</a></li>
        <li><a href="../panel_gerencia/hoja de vida eq/index.php">RLHV-E</a></li>
        <li><a href="../panel_gerencia/computadores/index.php">Computadores</a></li>
        <li><a href="../panel_gerencia/ubicacion/index.php">Ubicación</a></li>
        <li><a href="../panel_gerencia/depreciacion/index.php">Depreciacion</a></li>
  ...
  <div class="caja">
    ...
    <img src="../panel_gerencia/logo/jard.png" alt="Imagen">
  </div>
