...
<head>
  ...
  <link rel="stylesheet" href="../panel_tecnico/styles/styles5.css">
...
<body>
  ...
  <div>
    <ul class="navbar" id="myNavbar">
      <nav class="barra">
        <div class="logo">
          <img src="../panel_tecnico/logo/jard.png" alt="logo de pagina">
        </div>
        <!-- Opciones de navegación -->
        <li><a href="../panel_tecnico/tecnico_sistemas_panel.php">Inicio</a></li>
        <li><a href="../panel_tecnico/hoja de vida eq/index.php">RLHV-E</a></li>
        <li><a href="../panel_tecnico/computadores/index.php">Computadores</a></li>
        <li><a href="../panel_tecnico/ubicacion/index.php">Ubicación</a></li>
        <li><a href="../panel_tecnico/depreciacion/index.php">Depreciacion</a></li>
  ...
  <div class="caja">
    ...
    <img src="../panel_tecnico/logo/jard.png" alt="Imagen">
  </div>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-primary" data-dismiss="modal" onclick="redirectToIndex()">Aceptar</button>
        </div>
      </div>
    </div>
  </div>
