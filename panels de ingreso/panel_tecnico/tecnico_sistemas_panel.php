...
<head>
  ...
  <link rel="stylesheet" href="../panel_tecnico/stylesBoostrap/style_bienv_tecnico.css">
  ...
  <nav class="navbar navbar-expand-lg ">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item"><a class="nav-link" href="../panel_tecnico/hoja de vida eq/index.php">RLHV-E</a></li>
        <li class="nav-item"><a class="nav-link" href="../panel_tecnico/computadores/index.php">Computadores</a></li>
        <li class="nav-item"><a class="nav-link" href="../panel_tecnico/ubicacion/index.php">Ubicación</a></li>
        <li class="nav-item"><a class="nav-link" href="../panel_tecnico/depreciacion/index.php">Depreciacion</a></li>
      </ul>
    </div>
  </nav>
